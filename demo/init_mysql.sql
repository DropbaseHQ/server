...
INSERT INTO orders (user_id, product_name, quantity, total_price, order_date) VALUES
    ...
    (3, 'Mouse', 1, 25.50, '2023-02-05'),
    (4, 'Keyboard', 1, 50.00, '2023-03-12'),
    (1, 'Headphones', 2, 75.00, '2023-04-20'),
    (2, 'Monitor', 1, 300.00, '2023-05-01'),
    (1, 'Tablet', 1, 200.00, '2023-06-08'),
    (1, 'Printer', 1, 120.00, '2023-07-15'),
    (2, 'External HDD', 1, 80.00, '2023-08-22'),
    (3, 'Camera', 1, 350.00, '2023-09-30'),
    (2, 'Smartphone', 1, 600.00, '2023-10-10');
