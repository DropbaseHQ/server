...
#         # )
#         permissions = user_controller.get_user_permissions(
#             db=db, user_id=user.id, workspace_id=workspace_id
#         )
#         print("permissions", permissions.get("permissions"))

#         if self.action not in permissions or not permissions.get(self.action):
#             raise HTTPException(
#                 status_code=403,
