...
def test_create_component_req_text(test_client):
   ...
   # Assert
   assert isinstance(res_data.get("context").get("widgets").get("widget1").get("components").get("text2"), dict)
...
def test_create_component_req_select(test_client, dropbase_router_mocker):
   ...
   # Assert
   assert isinstance(res_data.get("context").get("widgets").get("widget1").get("components").get("select2"), dict)
   assert isinstance(res_data.get("state").get("widgets").get("widget1"), dict)
...
def test_create_component_req_input(test_client):
   ...
   # Assert
   assert isinstance(res_data.get("context").get("widgets").get("widget1").get("components").get("input2"), dict)
   assert isinstance(res_data.get("state").get("widgets").get("widget1"), dict)
...
def test_create_component_req_button(test_client):
   ...
   # Assert
   assert isinstance(res_data.get("context").get("widgets").get("widget1").get("components").get("button2"), dict)
   assert isinstance(res_data.get("state").get("widgets").get("widget1"), dict)
...
def test_update_component_req(test_client, dropbase_router_mocker):
   ...
   # Assert
   assert isinstance(res_data.get("context").get("widgets").get("widget1").get("components").get("button3"), dict)
   assert isinstance(res_data.get("state").get("widgets").get("widget1"), dict)
