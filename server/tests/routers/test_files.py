...
def test_get_all_files(test_client, mocker):
    # Arrange
...
def test_rename_file_req(test_client, mocker):
    # Arrange
    mocker.patch("server.requests.update_file_name", side_effect=update_file_name_response)
...
def test_delete_file_req(test_client, mocker):
    # Arrange
    mocker.patch("server.requests.delete_file", side_effect=delete_file_response)
