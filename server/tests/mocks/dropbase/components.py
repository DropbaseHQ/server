...
def create_component_response(payload: dict):
    ...
    return mock_response(
        json={
            ...
            "component": {
                "id": "20340c05-3e5e-4f2e-ad43-8a4377a4bb93",
                "property": property,
                "widget_id": "62a43f32-89f6-4143-a8e9-57cbdf0889b2",
                "type": type,
                "date": "2023-09-19 16:43:03.399592",
                "after": None,
            }
        }
    )
